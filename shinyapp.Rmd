...
# Load datasets
load(file="./datasets/backup_alzdatasets.RData", verbose=T)
...
sliderInput(inputId = "min_freq", 
            label = "Minimum number of diagnoses", 
            min = 20, 
            max = 5000, 
            value = 100)
...
Found a bug? If you know github, you can open an [issue](https://github.com/pohjois-savon-tietoallas/demo-alzheimer-shiny/issues). Otherwise contact the [creators](mailto:jani.miettinen@uef.fi?subject=I found a bug in Alzdemo).
</br>
**Datasets** are synthetic, but represent real world data. Original datasets are not available for users freely. If you are interested of the datasets, please contact [Reijo Sund](mailto:reijo.sund@uef.fi?subject=About alzdemo datasets).
</br>
